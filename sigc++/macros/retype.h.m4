...
ifelse($1,0,[dnl
  ...
  inline T_return operator()(LOOP(T_arg%1 _A_a%1, $1))
    { return T_return(this->functor_.template SIGC_WORKAROUND_OPERATOR_PARENTHESES<LOOP(typename ::sigc::type_trait<T_type%1>::take, $1)>
...
ifelse($1,0,[dnl
  ...
  inline void operator()(LOOP(T_arg%1 _A_a%1, $1))
    { T_return(this->functor_.template SIGC_WORKAROUND_OPERATOR_PARENTHESES<LOOP(typename ::sigc::type_trait<T_type%1>::take, $1)>
        (LOOP([[static_cast<T_type%1>(_A_a%1)]], $1)));
    }
